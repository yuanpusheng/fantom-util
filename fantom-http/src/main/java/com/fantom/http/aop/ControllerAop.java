...
public class ControllerAop {
    ...
    @Pointcut("execution(* com.fantom.http.control..*.*(..)) && @annotation(org.springframework.web.bind.annotation.RequestMapping)")
